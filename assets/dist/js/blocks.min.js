...
const { __: __$2 } = window.wp.i18n;
const { useState: useState$2, useEffect: useEffect$2, useCallback } = window.wp.element;
...
const { __: __$1 } = window.wp.i18n;
const { useState: useState$1, useEffect: useEffect$1 } = window.wp.element;
...
decodeEntities(billetSettings.title) || defaultBilletLabel;
