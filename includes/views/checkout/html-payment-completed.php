...
<div class="ph-checkout-v2">
    <div class="ph-checkout-v2__container">
        <div class="ph-checkout-v2__main">
            <div class="ph-checkout-v2__status-placeholder completed">
            ...
            <div class="ph-checkout-v2__details">
                <p class="ph-checkout-v2__amount"><?php _e('Pagamento Aprovado!', 'woo-boleto-paghiper'); ?></p>
                <p class="ph-checkout-v2__description">
                    <?php _e('Seu pedido foi confirmado e já estamos preparando tudo para o envio. Você receberá atualizações por e-mail.', 'woo-boleto-paghiper'); ?>
                </p>
